...
export const tr = {
  ...
  "menu.help.checkForUpdates": "Güncellemeleri Denetle…",
  ...
  "plugins.discover.loading": "Eklenti kataloğu yükleniyor…",
  "plugins.discover.offline": "Eklenti kaynağına ulaşılamadı. Bağlantını kontrol edip tekrar dene.",
  "plugins.discover.empty": "Burada henüz listelenen bir eklenti yok.",
  "plugins.discover.by": (author: string) => `Yazar: ${author}`,
  "plugins.discover.install": "Yükle",
  "plugins.discover.update": "Güncelle",
  "plugins.discover.installed": "Yüklü",
  "plugins.discover.incompatible": "Bu sunucuyla uyumlu değil",
  "plugins.discover.installSuccess": (name: string) => `${name} yüklendi.`,
  "plugins.discover.installFailed": (name: string, detail: string) => `${name} yüklenemedi: ${detail}`,
  "plugins.discover.source.label": "Kaynak",
  "plugins.discover.source.official": "Resmî",
  "plugins.discover.source.add": "Kaynak ekle…",
  "plugins.discover.source.addTitle": "Eklenti kaynağı ekle",
  "plugins.discover.source.addPrompt": "Bir macrogrid-index.json yayınlayan GitHub deposunun URL'sini (ya da owner/repo) yapıştır.",
  "plugins.discover.source.addFailed": (detail: string) => `Bu kaynak eklenemedi: ${detail}`,
  "plugins.discover.source.remove": "Bu kaynağı kaldır",
  "plugins.discover.source.removeConfirm": (name: string) => `"${name}" eklenti kaynağı olarak kaldırılsın mı? Ondan yüklenmiş olanlar etkilenmez.`,
  "plugins.discover.thirdParty.title": "Üçüncü taraf eklenti",
  "plugins.discover.thirdParty.warning": (repo: string) =>
    `Bu, resmî kaynaktan değil, ${repo} adresinden gelen üçüncü taraf bir eklenti — yalnızca yazarına güveniyorsan kur.`,
  "plugins.discover.thirdParty.fullAccess": "Bu bilgisayara tam erişimle çalışacak: dosyalarınızı okuyabilir, program başlatabilir ve internete bağlanıp veri gönderebilir. Macro Grid bunu sınırlayamaz ve kontrol edemez.",
  "plugins.discover.thirdParty.permissions": (list: string) => `Şunları istiyor: ${list}.`,
  "plugins.discover.link.install": "Bağlantıdan yükle…",
  "plugins.discover.link.title": "Bir depo bağlantısından yükle",
  "plugins.discover.link.prompt": "Kökünde bir plugin.json bulunan, tek eklentilik bir GitHub deposu URL'si (ya da owner/repo) yapıştır.",
  "plugins.discover.link.failed": (detail: string) => `Bu bağlantıdan yüklenemedi: ${detail}`,
  "plugins.discover.link.isSource": (repo: string) => `${repo} tek değil, birden fazla eklenti yayınlıyor (bir macrogrid-index.json). Bunun yerine kaynak olarak eklensin mi?`,
  "plugins.badge.official": "Resmî",
  ...
  "help.about.updates": "Macro Grid, yeni bir sürüm olup olmadığına bakmak için yaklaşık altı saatte bir kendiliğinden github.com adresine bağlanır. Sizinle veya bilgisayarınızla ilgili hiçbir bilgi gönderilmez ve siz onay vermeden hiçbir şey kurulmaz. Bunu Tercihler > Genel bölümünden kapatabilirsiniz.",
  ...
  "update.available": (v: string) => `${v} sürümü hazır`,
  "update.upToDate": "Uygulamanız güncel.",
  "update.current": (v: string) => `Şu anki sürüm: ${v}`,
  "update.release": (v: string) => `Sürüm ${v}`,
  "update.noNotes": "Bu sürüm için not yok.",
  "update.skipped": "Bu sürümü atladınız. İsterseniz yine de kurabilirsiniz.",
  "update.checkFailed": "Güncellemeler denetlenemedi. Daha sonra tekrar deneyin.",
  "update.checkNow": "Güncellemeleri denetle",
  ...
  "update.starting": "Kurulum penceresi açıldı. Orada devam edin: Macro Grid kendiliğinden kapanıp kurulumdan sonra yeniden açılacak.",
  "update.cancelled": "Güncelleme kurulmadı, hiçbir şey değişmedi. Macro Grid çalışmaya devam ediyor.",
  "update.manualOnly": "Bu sürüm kendiliğinden kurulamıyor. Sürüm sayfasından indirip kurabilirsiniz.",
  "update.error.declined": "Yönetici izni verilmedi, hiçbir şey değişmedi.",
  "update.error.refused": "Bu sürüm kendiliğinden kurulamıyor.",
  "update.error.download": "İndirme başarısız oldu. Daha sonra tekrar deneyin.",
  ...
  "variable.type.text": "metin",
  "variable.type.number": "sayı",
  "variable.type.boolean": "evet/hayır",
  "variable.type.duration": "süre",
  "variable.type.dateTime": "zaman",
  "variable.values": "Değerler",
  ...
  "dynamic.value.boolHint": "true / false; 1 / 0 da kabul edilir.",
  "dynamic.value.choiceHint": "Değişkenin alabileceği değerlerden birini seçin.",
