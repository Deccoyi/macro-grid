...
spaces. This covers the issues, pull requests and discussions of the three Macro Grid repositories (`macro-grid`, `macro-grid-client` and
`macro-grid-plugin`).

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement at
macrogrid.app@gmail.com (the project mailbox). All complaints will be reviewed and investigated promptly and fairly.
