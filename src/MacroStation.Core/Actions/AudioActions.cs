...
public sealed class SetVolumeAction(IAudioService audio) : IActionHandler
{
...
public sealed class SetMuteAction(IAudioService audio) : IActionHandler
{
...
public sealed class ToggleMuteAction(IAudioService audio) : IActionHandler
{
