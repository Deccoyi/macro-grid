...
Also done: stage 9 (widget text/icon dynamization).
1. **Stage 8:** packaging (`.msprofile` import/export, single-file publish + installer, signed APK).
2. **Stage 7:** JS plugin runtime (Jint sandbox, permissions, `plugin-html` bridge). Biggest item.
